...
//
//     final slokModel = slokModelFromJson(jsonString);

import 'dart:convert';

List<SlokModel> slokModelFromJson(String str) => List<SlokModel>.from(json.decode(str).map((x) => SlokModel.fromJson(x)));

String slokModelToJson(List<SlokModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class SlokModel {
  ...
  factory SlokModel.fromJson(Map<String, dynamic> json) => SlokModel(
    id: json["id"],
